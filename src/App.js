...
const App = () => {
  ...
  useEffect(() => {
    alanBtn({
      key: 'c9a20629fdc0045a1e6a06ca6681d18f2e956eca572e1d8b807a3e2338fdd0dc/stage',
  ...
  return (
    <div>
      <div className={classes.logoContainer}>
        ...
        <img src="https://i0.wp.com/synqqblog.wpcomstaging.com/wp-content/uploads/2019/07/screen-shot-2019-06-06-at-10.15.45-am.png?fit=400%2C136&ssl=1" className={classes.alanLogo} alt="logo" />
      </div>
